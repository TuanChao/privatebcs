...
export const SOCIAL_LIST = [
  {
    ...
    icon: (
      <svg
        ...
        viewBox="0 0 22 22"
      >
<path d="M22 12.07C22 6.48 17.52 2 12 2S2 6.48 2 12.07c0 5.01 3.66 9.17 8.44 9.92v-7.03H7.9V12.1h2.54V9.79c0-2.51 1.49-3.9 3.77-3.9 1.09 0 2.23.19 2.23.19v2.4h-1.26c-1.24 0-1.63.77-1.63 1.55v1.87h2.78l-.44 2.86h-2.34v7.03c4.78-.75 8.44-4.91 8.44-9.92z" fill="#ffffff"/>      </svg>
    ),
  ...
  // },
  {
    ...
    url: "mailto:Security@bkav.com.vn",
  },
  {
    title: "Diễn đàn",
    icon:(
      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"  xmlnsXlink="http://www.w3.org/1999/xlink" width="50" height="30" viewBox="10 -5 30 30">
  <defs>
    <linearGradient id="linear-gradient" x1="0.295" y1="0.063" x2="0.973" y2="1.437" gradientUnits="objectBoundingBox">
      ...
      <stop offset="0.269" stop-color="#ffffff"/>
      <stop offset="0.36" stop-color="#ffffff"/>
      <stop offset="0.456" stop-color="#ffffff"/>
      <stop offset="0.554" stop-color="#ffffff"/>
    ...
    <linearGradient id="linear-gradient-3" x1="1.033" y1="0.721" x2="0.222" y2="0.37" gradientUnits="objectBoundingBox">
      <stop offset="0.005" stop-color="#ffffff"/>
      <stop offset="0.056" stop-color="#ffffff"/>
