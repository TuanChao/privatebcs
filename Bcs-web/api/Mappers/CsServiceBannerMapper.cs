...
{
    // Duplicate definition removed. Ensure only one CsServiceBannerMapper exists in this namespace.

    public static class CsServiceBannerMapper
    {
        // Entity -> DTOrrr
        public static CsServiceBannerDto ToCsServiceBannerDto(this Manage manage)
        {
            if (manage == null) return null;

            return new CsServiceBannerDto
            {
        ...
        // DTO -> Entity
        public static Manage ToManage(this CsServiceBannerDto dto)
        {
